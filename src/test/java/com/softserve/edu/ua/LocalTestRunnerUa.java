...
/**
 * This class was implemented to create prerequisites for user with no taxes tests.
 */
public abstract class LocalTestRunnerUa {
    /**
     * Driver.
     */
    ...
    public void setUp() throws Exception {
        ...
        driver.findElement(By.xpath("//input[@id='input-email']")).sendKeys("spirnyak2010_2@gmail.com");
        //
        // Type Password
