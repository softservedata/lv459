...
public class NavigationComponent {
	...
	private final String NAVIGATION_OPTIONS_TEXT_XPATH = "./a";
	...
	public WebElement getNavigationOptionByPartialName(String optionName) {
		...
		for (WebElement current : getListOptions()) {
			WebElement liCurrent = current.findElement(By.cssSelector(NAVIGATION_OPTIONS_TEXT_XPATH));
	...
	public void clickNavigationOptionByPartialName(String... optionName) {
		...
		if (optionName.length > 1) {
			...
			new NavigationComponent(currentElement, By.cssSelector(NAVIGATION_OPTIONS_LIST_XPATH))
