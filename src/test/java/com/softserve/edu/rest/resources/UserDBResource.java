...
public class UserDBResource extends RestQueries<SimpleEntity, SimpleEntity, SimpleEntity, SimpleEntity, SimpleEntity> {

    public UserDBResource() {
        super(RestUrlRepository.getAdminUser(), SimpleEntity.class, SimpleEntity.class,
