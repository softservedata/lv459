...
public class ItemsResource extends RestQueries<SimpleEntity, SimpleEntity, SimpleEntity, SimpleEntity, SimpleEntity> {

    public ItemsResource() {
        super(RestUrlRepository.getItems(), SimpleEntity.class, SimpleEntity.class,
